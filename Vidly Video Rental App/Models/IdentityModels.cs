...
namespace Vidly_Video_Rental_App.Models
{
    ...
    /// <summary>
    /// Holds the profile data for the users in our application. We can add new profile data
    /// by adding more properties to the ApplicationUser class. This information will be asked
    /// when a new user tries to sign up in the application
    /// </summary>
